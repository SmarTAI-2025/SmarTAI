...
> 2026-08-30 集成说明：Mail A、Front A、Mail B、Front B 已在同一个基于最新 `main` 的候选分支完成组合收口；下方 2026-08-28 数字仅保留为历史基线，当前候选以 PR exact head 和新测试结果为准。
...
SMARTAI_SMTP_TIMEOUT_SECONDS=10
```
