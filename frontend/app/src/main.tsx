...
const RegisterCheckEmailPage = React.lazy(() =>
  import("@/routes/RegisterCheckEmailPage").then((module) => ({ default: module.RegisterCheckEmailPage })),
);
const RegisterVerifyPage = React.lazy(() =>
  import("@/routes/RegisterVerifyPage").then((module) => ({ default: module.RegisterVerifyPage })),
);
