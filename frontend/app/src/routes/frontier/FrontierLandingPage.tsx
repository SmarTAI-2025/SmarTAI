        ...
        <section id="ask-smartai" className="frontier-ask-section">
          ...
          <div className="frontier-ask-workbench">
            <div className="frontier-ask-console">
              ...
              <div className="frontier-conversation-stack">
                {insights.map((item, index) => {
                  const isActive = activeInsight === index;
                  return (
                    <div
                      className={`frontier-conversation${isActive ? " is-active" : ""}`}
                      aria-hidden={!isActive}
                      data-insight={item.id}
                      key={item.id}
                    >
                      ...
                      <div className="frontier-smartai-answer">
                        <span>SmarTAI</span>
                        <p>{item.answer}</p>
                      ...
                      <div className="frontier-teacher-query frontier-followup-query">
                        ...
                        <p>{item.followUpQuery}</p>
                      </div>
                      <div className="frontier-smartai-answer frontier-followup-answer">
                        <span>SmarTAI</span>
                        <p>{item.followUpAnswer}</p>
                      </div>
                    </div>
                  );
                })}
            ...
            {insights.map((item, index) => {
              ...
              return (
                <div
                  className={`frontier-generated-chart${isActive ? " is-active" : ""}`}
                  aria-hidden={!isActive}
                  data-insight={item.id}
                  key={`${item.id}-chart`}
                >
                  ...
                  <InsightChart insight={item} locale={locale} />
