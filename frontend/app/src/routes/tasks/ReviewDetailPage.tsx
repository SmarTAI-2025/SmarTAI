import { ResultQuestionSearch as QuestionSearch } from "@/components/tasks/ResultQuestionSearch";
...
export function ReviewDetailPage() {
  ...
  const questionById = useMemo(() => new Map(model.questions.map((item) => [item.id, item])), [model.questions]);
